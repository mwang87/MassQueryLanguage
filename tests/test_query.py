...
def test_nocache():
    query = "QUERY scaninfo(MS2DATA)"
    results_df = msql_engine.process_query(query, "tests/data/QC_0.mzML", cache=None, parallel=False)
...
def test_advanced_filters2():
    query = """
        QUERY MS1DATA FILTER MS1MZ=515:TOLERANCEMZ=35:MASSDEFECT=massdefect(min=0.1332, max=0.2112)
    """
