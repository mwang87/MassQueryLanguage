mkdir -p data
cd data
wget --no-verbose --output-document=GNPS00002_A3_p.mzML "https://massive.ucsd.edu/ProteoSAFe/DownloadResultFile?forceDownload=true&file=f.MSV000084494/ccms_peak/raw/GNPS00002_A3_p.mzML"
wget --no-verbose --output-document=GNPS00002_A3_p.mzml "https://massive.ucsd.edu/ProteoSAFe/DownloadResultFile?forceDownload=true&file=f.MSV000084494/ccms_peak/raw/GNPS00002_A3_p.mzML"
wget --no-verbose --output-document=GNPS00002_A10_n.mzML "https://massive.ucsd.edu/ProteoSAFe/DownloadResultFile?forceDownload=true&file=f.MSV000084494/ccms_peak/raw/GNPS00002_A10_n.mzML"
wget --no-verbose --output-document=QC_0.mzML "https://massive.ucsd.edu/ProteoSAFe/DownloadResultFile?forceDownload=true&file=f.MSV000085852/ccms_peak/QC_raw/QC_0.mzML"
wget --no-verbose --output-document=bld_plt1_07_120_1.mzML "https://massive.ucsd.edu/ProteoSAFe/DownloadResultFile?forceDownload=true&file=f.MSV000085944/ccms_peak/raw_data/bld_plt1_07_120_1.mzML"
wget --no-verbose --output-document=NS_1x_test.mzML "https://massive.ucsd.edu/ProteoSAFe/DownloadResultFile?forceDownload=true&file=f.MSV000087352/updates/2021-05-03_allegraaron_95d2215b/peak/NS_1x_test.mzML"
wget --no-verbose --output-document=JB_182_2_fe.mzML "https://massive.ucsd.edu/ProteoSAFe/DownloadResultFile?forceDownload=true&file=f.MSV000084289/ccms_peak/JB_182_2_fe.mzML"
wget --no-verbose --output-document=S_N2_neutral_Zn.mzML "https://massive.ucsd.edu/ProteoSAFe/DownloadResultFile?forceDownload=true&file=f.MSV000083387/updates/2019-11-12_allegraaron_e893cb7e/peak/S_N2_neutral_Zn.mzML"
...
wget --no-verbose --output-document=Hui_N2_fe.mzML "https://massive.ucsd.edu/ProteoSAFe/DownloadResultFile?forceDownload=true&file=f.MSV000084628/ccms_peak/Hui_N2_fe.mzML"
