...
def translate_query(query, language="english"):
    ...
    if len(parsed_query["conditions"]) > 0:
        ...
        if language == "russian":
            ...
            sentences.append("Die folgenden Bedingungen werden auf die Daten der Massenspektrum verwendet.")
...
def _translate_querytype(querytype, language="english"):
    ...
    if querytype["function"] == "functionscaninfo":
        ...
        if language == "arabic":
            return "ترتيب الشاملة على {}.".format(ms_level)
        if language == "russian":
    ...
    if querytype["function"] == "functionscansum":
        ...
        if language == "russian":
            ...
            return "Zurückgeben der Summeninformation über den Scan {}.".format(ms_level)
        elif language == "spanish":
...
def _translate_condition(condition, language="english"):
    ...
    if condition["type"] == "ms2neutrallosscondition":
        ...
        if language == "russian":
            ...
            return "Mittels MS2neutral losspeak auf m/z {} {}.".format(condition["value"][0], qualifier_string)
        elif language == "spanish":
    ...
    if condition["type"] == "ms1mzcondition":
        ...
        if language == "russian":
            ...
            return "Mittels MS1peak auf m/z {} {}.".format(condition["value"][0], qualifier_string)
        elif language == "spanish":
    ...
    if condition["type"] == "ms2precursorcondition":
        ...
        if language == "russian":
            ...
            return "Mittels MS2peak mit einem Vorprozess m/z {} {}.".format(condition["value"][0], qualifier_string)
        elif language == "spanish":
...
def _translate_qualifiers(qualifiers, language="english"):
    ...
    if language == "arabic":
        return "أو ".join(qualifier_phrases)
    if language == "russian":
...
def _translate_qualifier(qualifier, language="english"):
    if qualifier["name"] == "qualifierppmtolerance":
        ...
        if language == "arabic":
            return "تماما قفل {} ppm بالتخفيف".format(qualifier["value"])
        if language == "russian":
    ...
    if qualifier["name"] == "qualifiermztolerance":
        ...
        if language == "arabic":
            return "تماما قفل {} m/z بالتخفيف".format(qualifier["value"])
        if language == "russian":
    ...
    if qualifier["name"] == "qualifierintensitypercent":
        ...
        if language == "arabic":
            return "تماما قفل {} % من الارزش القاعدي".format(qualifier["value"])
        if language == "russian":
            ...
            return "eine minimale Intensität pro Marker pro {}%".format(qualifier["value"])
        elif language == "spanish":
    ...
    if qualifier["name"] == "qualifierintensityreference":
        ...
        if language == "arabic":
            return "ارزش هذا بخصوص مصدر مسار في سيستم المحصولات"
        if language == "russian":
            ...
            return "Dieserpeak wird zur Intensitätsreferenz für andere Peaks verwendet"
        elif language == "spanish":
    ...
    if qualifier["name"] == "qualifierintensitymatch":
        ...
        if language == "arabic":
            return "تماما قفل {} من الارزش الموافق".format(qualifier["value"])
        if language == "russian":
            ...
            return "eine erwartete Intensität pro Referenzpeak von {}".format(qualifier["value"])
        elif language == "spanish":
    ...
    if qualifier["name"] == "qualifierintensitytolpercent":
        ...
        if language == "russian":
            ...
            return "eine Erweiterung der Erwartungswerte um {}% in der Intensität".format(qualifier["value"])
        elif language == "spanish":
